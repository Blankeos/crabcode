...
Most OpenCode docs apply directly: config is JSON/JSONC, project assets live under `.opencode/`, and command files use the OpenCode markdown command format. crabcode adds a small terminal-specific layer for sounds, notifications, and theme selection.
...
| `sounds` |  | ✅ | crabcode-specific terminal audio and notifications. |
| `notifications` |  | ✅ | crabcode-specific terminal completion signals such as Zed tab dots. |
